#!/usr/bin/env python3
"""
Seashell 25view Full-Distill (A配置: warmup=1000, interval=4, max_weight=0.5, tv=0.1)
补充之前缺失的实验
"""
...
EXPERIMENTS = [
    {"name": "seashell_25v_full_distill_A", "views": 25,
...
def main():
    ...
    print(f"\n{'='*90}")
    print("Seashell 25v Full-Distill 实验结果")
    print(f"{'='*90}")
    print(f"{'实验':<35} {'PSNR':>8} {'SSIM':>10} {'时间':>8}")
    print("-" * 70)
    # 参考值
    refs = [
        ("Seashell 25v Baseline",        40.42, 0.9417, 7),
        ("Seashell 25v Delayed-Distill", 39.39, 0.9442, 14.4),
    ...
    with open("experiments/distill/seashell_ablation/results_full_distill_25view.json", "w") as f:
