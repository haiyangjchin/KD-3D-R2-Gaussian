#!/usr/bin/env python3
"""
Seashell 25/50/75view Delayed-Distill (配置: warmup=5000, interval=8, max_weight=0.5, tv=0.2)
顺序执行: 先25v，再50v，最后75v
参照Pine/Walnut Delayed-Distill实验配置
"""
...
# 顺序执行: 先25v，再50v，最后75v
EXPERIMENTS = [
    {"name": "seashell_25v_delayed_distill_I", "views": 25,
     "desc": "25view Delayed-Distill I: w=5k, i=8, mw=0.5, tv=0.2"},
    {"name": "seashell_50v_delayed_distill_I", "views": 50,
     "desc": "50view Delayed-Distill I: w=5k, i=8, mw=0.5, tv=0.2"},
    {"name": "seashell_75v_delayed_distill_I", "views": 75,
     "desc": "75view Delayed-Distill I: w=5k, i=8, mw=0.5, tv=0.2"},
]
...
BASE_CFG = {
    ...
    "lambda_dssim": 0.25, "lambda_tv": 0.2, "tv_vol_size": 32,  # tv=0.2 for delayed-distill
    ...
    # Delayed-Distill配置 (参照Pine/Walnut)
    "distill_warmup_iters": 5000,  # w=5k
    "distill_interval": 8,         # i=8
    "max_distill_weight": 0.5,     # mw=0.5
...
def main():
    ...
    print(f"\n{'='*90}")
    print("Seashell 25/50/75v Delayed-Distill 实验结果")
    print(f"{'='*90}")
    ...
    refs = [
        ...
        ("Seashell 25v Full-Distill", 39.39, 0.9442, 15),
    ...
    with open("experiments/distill/seashell_ablation/results_delayed_distill_25_50_75.json", "w") as f:
