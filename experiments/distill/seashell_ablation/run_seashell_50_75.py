#!/usr/bin/env python3
"""
Seashell 50/75view masked自蒸馏 - V配置
教师: 75view baseline vol_pred (PSNR=42.55)
"""
...
EXPERIMENTS = [
    {"name": "seashell_50view_V", "views": 50, "desc": "50view masked self-distill V"},
    {"name": "seashell_75view_V", "views": 75, "desc": "75view masked self-distill V"},
]
...
def main():
    ...
    print(f"\n{'=' * 90}")
    print("Seashell 50/75view 结果")
    print(f"{'=' * 90}")
    print(f"{'实验':<25} {'PSNR':>8} {'SSIM':>10} {'时间':>8}")
    print("-" * 60)
    print(f"{'50v baseline':<25} {'42.61':>8} {'0.9571':>10}")
    print(f"{'75v baseline':<25} {'42.55':>8} {'0.9575':>10}")
    for n, r in results.items():
        print(f"{n:<25} {r['psnr']:>8.2f} {r['ssim']:>10.4f} {r['time_min']:>7.1f}m")
    print("-" * 60)

    with open("experiments/distill/seashell_ablation/results_50_75view.json", "w") as f:
