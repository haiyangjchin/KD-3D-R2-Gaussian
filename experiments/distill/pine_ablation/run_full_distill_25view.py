#!/usr/bin/env python3
"""
Pine 25view Full-Distill (A配置: warmup=1000, interval=4, max_weight=0.5, tv=0.1)
"""
...
EXPERIMENTS = [
    {"name": "pine_25v_full_distill_A", "views": 25,
     "desc": "25view Full-Distill A: w=1k, i=4, mw=0.5, tv=0.1"},
]
...
def main():
    ...
    print(f"\n{'='*90}")
    print("Pine 25v Full-Distill 实验结果")
    print(f"{'='*90}")
    ...
    with open("experiments/distill/pine_ablation/results_full_distill_25view.json", "w") as f:
