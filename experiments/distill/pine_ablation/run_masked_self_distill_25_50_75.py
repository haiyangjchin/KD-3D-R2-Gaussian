#!/usr/bin/env python3
"""
Pine 25/50/75view Masked Self-Distill (mw=0.5, tv=0.05)
...
TEACHER_PATH = "experiments/baseline/baseline_75view_pine/test/iter_10000/vol_pred.npy"
...
def run_one(exp):
    ...
    cfg = dict(BASE_CFG)
    cfg["source_path"] = f"./data/real_dataset/cone_ntrain_{views}_angle_360/pine"
...
def main():
    ...
    print(f"\n{'='*90}")
    print("Pine 25/50/75v Masked Self-Distill 实验结果")
    print(f"{'='*90}")
    ...
    refs = [
        ...
        ("Pine 25v Full-Distill",    38.56, 0.9305, 25.8),
        ("Pine 25v Delayed-Distill", 38.73, 0.9289, 9),
        ("Pine 50v Baseline",        39.13, 0.9418, 7),
        ("Pine 50v Full-Distill",    40.86, 0.9457, 26.8),
        ("Pine 50v Delayed-Distill", 40.69, 0.9421, 9),
        ("Pine 75v Baseline",        39.05, 0.9435, 7),
        ("Pine 75v Full-Distill",    41.27, 0.9477, 26.8),
        ("Pine 75v Delayed-Distill", 41.02, 0.9436, 9),
    ]
    for n, p, s, t in refs:
    ...
    with open("experiments/distill/pine_ablation/results_masked_self_distill_25_50_75.json", "w") as f:
