...
print("Starting 75-view pine baseline training in background...")
...
cmd = [
    ...
    "--config",
    "E:\\r2_gaussian\\experiments\\baseline\\baseline_75view_pine.yaml",
]

# Output log file
log_file = "E:\\r2_gaussian\\experiments\\baseline\\baseline_75view_pine.log"
...
try:
    ...
    print(
        f"Output directory: E:\\r2_gaussian\\experiments\\baseline\\baseline_75view_pine"
    )
    print()
